...
__kvmtest_run alias $testAlias $TestRuntimeVersion -arch "x86" -r "CLR"
__kvmtest_run use none

Describe "use" -Tag "use" {
    Context "When use-ing without a clr or architecture" {
        __kvmtest_run use $TestRuntimeVersion
    ...
    Context "When use-ing a non-existant version" {
        It "should throw an error" {
            __kvmtest_run use $notRealRuntimeVersion
    ...
    Context "When use-ing a non-existant alias" {
        It "should throw an error" {
            __kvmtest_run use "bogus_alias_that_does_not_exist"
